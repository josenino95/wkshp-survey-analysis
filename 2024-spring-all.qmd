---
title: "Spring 2024 - All Workshops Survey Responses"
...
workshops <- c("2024-05-01-ucsb-r", "2024-06-04-ucsb-containers", "2024-06-10-ucsb-geospatial")
...
results %>% 
  ...
  arrange(workshop, agree_apply.post)
```
...
results %>% 
  ...
  arrange(workshop, agree_comfortable.post)
```
...
results %>% 
  ...
  arrange(workshop, agree_clearanswers.post)
```
...
results %>% 
  ...
  arrange(workshop, agree_instr_enthusiasm.post)
```
...
results %>% 
  ...
  arrange(workshop, agree_instr_interaction.post)
```
...
results %>% 
  ...
  arrange(workshop, agree_instr_knowledge.post)
```
